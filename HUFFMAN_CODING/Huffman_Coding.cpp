...
void encode::create_binary_file(){
    ...
    cout<<"\n\nBinary File Created Successfully! Do You Want To Print The Contents Of The Binary File?\n\nPress 1 To Print.\nPress Any Other Number To Continue Without Printing."<<endl<<endl;
    for(int a=0;a<=100000000;a++){}
    cout<<"Enter Your Choice: ";
    cin>>choice;
    if(choice==1){
    ...
    for(int a=0;a<=100000000;a++){}
    cout<<"\nA Compression Of Approximately "<<(float(original_size-compressed_size)/original_size)*100<<"% was achieved."<<endl;
}
...
void decode::get_text_from_bin(){
    ...
    cout<<"Writing Into DECODED_TEXTFILE.txt Was Completed."<<endl<<endl;
